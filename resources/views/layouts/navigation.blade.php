    ...
    <div class="flex justify-between h-16">
      ...
      <div class="hidden sm:flex sm:items-center sm:ml-6">
        <form action="{{ route('search') }}" method="GET">
          <div class="flex">
            <div
              class="flex w-10 items-center justify-center rounded-tl-lg rounded-bl-lg 
            ...
            <x-text-input type="text" name="search" required value="{{ request()->input('search') }}"
              placeholder="Search" />
            <input type="submit" value="Search"
              class="bg-blue-500 p-2 rounded-tr-lg rounded-br-lg text-white font-semibold hover:bg-blue-800 transition-colors" />
          </div>
          {{-- <input type="text" name="search" required value="{{ request()->input('search') }}" /> --}}
